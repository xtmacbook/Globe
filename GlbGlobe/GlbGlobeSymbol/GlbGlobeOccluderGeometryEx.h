...
class OccluderGeometry : public osg::Drawable
{
    public :
        OccluderGeometry();
		...
		void computeOccluderGeometryEx(osg::Node* subgraph, osg::Matrixd* matrix, double sampleRatio=1.0f);
...
class ShadowVolumeGeometry : public osg::Drawable
{
    public :
