...
GlbGlobeAutoDrill::GlbGlobeAutoDrill():
...
GlbGlobeAutoDrill::GlbGlobeAutoDrill(const GlbGlobeAutoDrill& pat,const CopyOp& copyop):
AutoTransform(pat,copyop),
...
void GlbGlobeAutoDrill::setAutoRotateMode(AutoRotateMode mode)
{
...
void GlbGlobeAutoDrill::setAxis(const Vec3& axis)
{
	_axis = axis;
	_axis.normalize();
	updateCache();
...
void GlbGlobeAutoDrill::setNormal(const Vec3& normal)
{
	_normal = normal;
	_normal.normalize();
	updateCache();
...
void GlbGlobeAutoDrill::updateCache()
{
...
void GlbGlobeAutoDrill::setScale(const Vec3d& scale)
{
	_scale = scale;
...
bool GlbGlobeAutoDrill::computeLocalToWorldMatrix(Matrix& matrix,NodeVisitor*) const
{
...
bool GlbGlobeAutoDrill::computeWorldToLocalMatrix(Matrix& matrix,NodeVisitor*) const
{
...
void GlbGlobeAutoDrill::computeMatrix() const
{
...
BoundingSphere GlbGlobeAutoDrill::computeBound() const
{
...
void GlbGlobe::GlbGlobeAutoDrill::accept( NodeVisitor& nv )
{
