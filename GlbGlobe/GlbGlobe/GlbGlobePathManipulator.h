...
* All rights reserved.
*
* @file    GlbGlobePathManipulator.h
* @brief   球模式下路径漫游操控器类头文件
*
* @version 1.0
* @author  敖建
* @date    2014-7-8 9:54
...
{ 
	...
	* @date    2014-7-8 10:40
	*/
	class GLB_DLLCLASS_EXPORT CGlbGlobePathManipulator : public osgGA::CameraManipulator,
	...
	public:
		...
		* @brief 构造函数
		*/
		CGlbGlobePathManipulator(CGlbGlobe* globe, CGlbGlobeDynamic *dynamicObj);
		/**
		* @brief 析构函数
		*/
		~CGlbGlobePathManipulator(void);
	...
	private:
		...
		* @brief 计算相机矩阵
		*/
		osg::Matrixd computeMatrix();
	private:
		CGlbGlobe* mpr_globe;
		CGlbGlobeDynamic*/*glbref_ptr<CGlbGlobeDynamic>*/ mpr_dynamicObj;				//动态对象
