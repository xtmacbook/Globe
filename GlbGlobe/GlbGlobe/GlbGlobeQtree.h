/********************************************************************
  ...
  * All rights reserved.
  *
  * @file    GlbGlobeQtree.h
  * @brief   Globe四叉树类头文件
  *
  * 这个档案定义CGlbGlobeQtree这个class,管理贴地形绘制的object对象(添加，删除)
  *
  * @version 1.0
  * @author  马林
...
namespace GlbGlobe
{
	...
	* @date    2014-5-13 10:40
	*/
	class GLB_DLLCLASS_EXPORT CGlbGlobeQtree
	{
	public:
		CGlbGlobeQtree(CGlbGlobeQtree* p);
		~CGlbGlobeQtree(void);
		...
		*/
		void GetChildIndexes( CGlbAxisAlignedBox& , long *x, long *y ) const;
	...
	public:
		...
		*/
		CGlbGlobeQtree * mpr_p_children[ 2 ][ 2 ];
