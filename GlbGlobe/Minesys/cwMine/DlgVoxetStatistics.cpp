...
void CDlgVoxetStatistics::OnBnClickedButton2()
{
	...
	for (int i=0;i<nItemCount;i++)
	{
		m_Statistics.GetSubItemRect(i,1,LVIR_LABEL,rc);//获得子项的RECT；
	...
	for (int i=0;i<nItemCount;i++)
	{
		m_Statistics.GetSubItemRect(i,2,LVIR_LABEL,rc);//获得子项的RECT；
	...
	//for (int i=0;i<nItemCount;i++)
	//{
	//	m_Statistics.GetSubItemRect(i,3,LVIR_LABEL,rc);//获得子项的RECT；
